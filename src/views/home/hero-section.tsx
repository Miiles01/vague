  ...
  >
    <span className="flex flex-col justify-between">
      ...
      <span className="flex -space-x-2">
        {["/assets/avatares/6339f3000c19ca36b334c4112414e95f.jpg", "/assets/avatares/6568484d9a0be86bd9591731c02cae28.jpg", "/assets/avatares/8b083774fbdc0fde07641da720c9e945.jpg", "/assets/avatares/8b793e055ca3578f3544c6819163e5fd.jpg"].map((src) => (
          <Image
            key={src}
            src={src}
            alt="Student"
            width={20}
            height={20}
            className="size-5 rounded-pill border border-brand-deep/40 object-cover bg-surface"
          />
        ))}
      </span>
