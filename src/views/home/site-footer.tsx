...
export const SiteFooter = ({ brand, cta, footer }: SiteFooterProps) => {
  ...
  return (
    <footer
      id="contact"
      className="mt-3 rounded-card-lg bg-brand-deep px-6 py-14 text-on-brand sm:px-10 md:px-20 lg:px-32 xl:px-48 sm:py-16 md:py-32 lg:py-40"
    >
    {/* CTA */}
    ...
    <div className="grid gap-10 py-14 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
      <div className="max-w-xs">
        <span className="flex items-center gap-2 text-lg font-medium tracking-[0.2em] uppercase">
          <BrandMark className="size-5" title={`$<div className="flex flex-col"><span className="leading-none">{brand}</span><span className="text-[10px] tracking-widest opacity-60 leading-none mt-1">TAEKWONDO</span></div> logo`} />
