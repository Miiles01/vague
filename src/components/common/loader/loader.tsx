 ...
 */
export const Loader = ({ brand = "Vague Bleue" }: LoaderProps) => {
  ...
  return (
    <Spring
      ...
      className="fixed inset-0 z-[9999] flex flex-col items-center justify-center gap-8 bg-brand-deep text-on-brand"
      role="status"
      aria-live="polite"
      aria-label="Loading"
    >
      ...
      >
        <BrandMark className="size-7" title={`$<div className="flex flex-col"><span className="leading-none">{brand}</span><span className="text-[12px] tracking-widest opacity-60 leading-none mt-2">TAEKWONDO</span></div> logo`} />
